...
#Adaptee
class Socket(AdapterInterface):
    def receive_request(self):
        return self._info.updateinfo()

 #Target interface       
class MainSocketInterface:
    def  insert_Scrape(self):
        pass

#The Adapter
class Adapter(MainSocketInterface):
    _socket = None
